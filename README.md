This project is a fork of the [API Based Weather Report](https://github.com/Mrinank-Bhowmick/python-beginner-projects/tree/main/projects/API%20Based%20Weather%20Report) 
originally created by [Mrinank Bhowmick](https://github.com/Mrinank-Bhowmick). 
